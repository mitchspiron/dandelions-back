...
const post_category_controller_1 = require("./post-category.controller");
...
PostCategoryModule = __decorate([
    (0, common_1.Module)({
        imports: [],
        controllers: [post_category_controller_1.PostCategoryController],
        providers: [post_category_service_1.PostCategoryService],
    })
], PostCategoryModule);
