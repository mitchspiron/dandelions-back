/*
  ...
  - Added the required column `abonnee` to the `entreprise` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `entreprise` ADD COLUMN `abonnee` BOOLEAN NOT NULL;
