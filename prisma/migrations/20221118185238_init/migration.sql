/*
  ...
  - Added the required column `isArchived` to the `evenement` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `evenement` ADD COLUMN `isArchived` BOOLEAN NOT NULL;
