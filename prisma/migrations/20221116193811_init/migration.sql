/*
  ...
  - You are about to drop the column `etat_articleId` on the `article` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE `article` DROP COLUMN `etat_articleId`;
