/*
  ...
  - You are about to drop the column `statistique` on the `entreprise` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE `entreprise` DROP COLUMN `statistique`;
